        ...
        <v-row>
          ...
          <v-col cols="3">
            <v-card-text align="center" class="pb-0"
              >Data Information <v-divider
            /></v-card-text>
            <v-card-text class="pt-3 pb-0">
              Start Date: <b>{{ formatDateToReadable(start_date) }}</b
              ><br />
              End Date: <b>{{ formatDateToReadable(end_date) }}</b
              ><br />
              <br /><v-divider />
            </v-card-text>

            <div class="text-center pa-4">
              <v-btn @click="dialog = true"> View Detail </v-btn>
