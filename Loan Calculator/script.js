const form = document.getElementById('myForm');
  ...
  form.addEventListener('submit', (e) => {
      ...
      let paymentAmountRef = document.getElementById("paymentAmount");
      ...
      if(totalMonth === 0){
        ...
        paymentAmountRef.value = statement + "$" + (Number(loanAmount) * 
        ((((annualIR)*(1 + annualIR)**totalMonth))/(((1 + annualIR)**totalMonth) - 1))).toFixed(2);
      }
  });